...
(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=millu';
                a.target = '_blank';
                a.rel = 'noopener';
    ...
    // ─── 0. CONFIG — Ótica Millu (Tray store 1269258) ───────────────────
    ...
    const MILLU_STORE_WHATSAPP = '5514996310165'; // WhatsApp da loja (14) 99631-0165 — tela de limite
    ...
    function init() {
        ...
        loadingT2.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=millu';
        ...
        footer.href = 'https://provoulevou.com.br?utm_source=widget&utm_medium=lojista&utm_campaign=millu';
        ...
        function loadRelatedProducts() {
            ...
            items.forEach(function(item) {
                ...
                // Link
                var linkEl = item.querySelector('a[href*="millushop"]');
        ...
        async function runGeneration() {
            ...
            try {
                ...
                console.log('[PL Millu] Enviando', allProdImgs.length, 'fotos do produto');
